...
const ThemSettings = () => {
  ...
  const {themeSettings, setThemeSettings,setColor,setMode,currentMode, setCurrentMode,currentColor, setCurrentColor}=useStateContext();
  return (
        ...
        <div className='flex gap-3'>
          {themeColors.map((item , index)=>(
            <TooltipComponent key={index} content={item.name} position='TopCenter' >
              <div className='flex relative gap-5 items-center mt-2 cursor-pointer'>
                <button
                type='button'
